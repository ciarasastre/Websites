function booksGalore(){
		...
		document.getElementById("storedBooks").style.backgroundColor = "pink";
...
function spaceCats(){
		...
		document.getElementById("storedBooks").style.backgroundColor = "#B284BE";
...
function sailorsWake(){
		...
		document.getElementById("themes").style.backgroundColor = "black";
		document.getElementById("themes").style.color = "white";
		document.getElementById("storedBooks").style.backgroundColor = "#232B2B";
...
function Fantasy(){
		...
		document.getElementById("themes").style.backgroundColor = "black";
		document.getElementById("themes").style.color = "white";
		document.getElementById("storedBooks").style.backgroundColor = "#A9A9A9";
...
//Recovers book that was previousally written
function bookLoad(){
	document.getElementById("text").value;
	document.getElementById("storedBooks").innerHTML = "text";
